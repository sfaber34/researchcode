pro nevzorovVRelationshiptwc
  ...
  if findRange eq 'true' then begin
    ...
    ;--CACLULATE Y RANGE--
    liqColPowerA=[vtwccol[aStartA:aEndA]*itwccol[aStartA:aEndA],vtwccol[bStartA:bEndA]*itwccol[bStartA:bEndA],vtwccol[cStartA:cEndA]*itwccol[cStartA:cEndA],vtwccol[dStartA:dEndA]*itwccol[dStartA:dEndA],vtwccol[eStartA:eEndA]*itwccol[eStartA:eEndA]]
    liqColPowerB=[vtwccol[aStartB:aEndB]*itwccol[aStartB:aEndB],vtwccol[bStartB:bEndB]*itwccol[bStartB:bEndB],vtwccol[cStartB:cEndB]*itwccol[cStartB:cEndB],vtwccol[dStartB:dEndB]*itwccol[dStartB:dEndB],vtwccol[eStartB:eEndB]*itwccol[eStartB:eEndB]]
    liqColPowerC=[vtwccol[aStartC:aEndC]*itwccol[aStartC:aEndC],vtwccol[bStartC:bEndC]*itwccol[bStartC:bEndC],vtwccol[cStartC:cEndC]*itwccol[cStartC:cEndC],vtwccol[dStartC:dEndC]*itwccol[dStartC:dEndC],vtwccol[eStartC:eEndC]*itwccol[eStartC:eEndC]]

    liqRefPowerA=[vtwcref[aStartA:aEndA]*itwcref[aStartA:aEndA],vtwcref[bStartA:bEndA]*itwcref[bStartA:bEndA],vtwcref[cStartA:cEndA]*itwcref[cStartA:cEndA],vtwcref[dStartA:dEndA]*itwcref[dStartA:dEndA],vtwcref[eStartA:eEndA]*itwcref[eStartA:eEndA]]
    liqRefPowerB=[vtwcref[aStartB:aEndB]*itwcref[aStartB:aEndB],vtwcref[bStartB:bEndB]*itwcref[bStartB:bEndB],vtwcref[cStartB:cEndB]*itwcref[cStartB:cEndB],vtwcref[dStartB:dEndB]*itwcref[dStartB:dEndB],vtwcref[eStartB:eEndB]*itwcref[eStartB:eEndB]]
    liqRefPowerC=[vtwcref[aStartC:aEndC]*itwcref[aStartC:aEndC],vtwcref[bStartC:bEndC]*itwcref[bStartC:bEndC],vtwcref[cStartC:cEndC]*itwcref[cStartC:cEndC],vtwcref[dStartC:dEndC]*itwcref[dStartC:dEndC],vtwcref[eStartC:eEndC]*itwcref[eStartC:eEndC]]
